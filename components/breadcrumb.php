...
<div class="" data-aos="fade-up" data-aos-offset="100" data-aos-delay="50" data-aos-duration="1000"
    ...
    <div class="back-to-home d-flex align-items-baseline justify-content-center" style="margin-top:123px; ">
        <!--  margin-bottom:-123px; -->


        <div class="d-flex align-items-center justify-content-center rounded  " style="  ">

...
<main class="front-page flex-grow-1">
    ...
    <div style="height:;">
        ...
        <div class="container" id="testimonials">
            ...
            <div class="row d-none d-md-flex d-lg-flex container2 gy-2">
                <?php
                foreach (get_field("testimonials_section") as $testimonial) {
                    ?>
        ...
        <div class="mask-group">
            ...
            <div class="container">
                <div class="row d-none d-md-none d-lg-flex flex-row align-items-center justify-content-between" style="margin-top:100px">
                    <?php
                    foreach (get_field("sue_partners") as $sue) {
                        ?>
                         <div class="col-auto">
                             <a href=" <?= $sue['sue_partners_link_url']['url'] ?>">
                                <div style="border-radius:15px; height:99px; margin:35px 0;">
                                    <div class="d-flex flex-row align-items-center justify-content-around gap-1"
                                        ...
                                        <img src="<?= $sue['sue_partners_img']['url'] ?>" alt=" <?= $sue['sue_partners_img']['alt'] ?>"
                                            class="sue-img" style="width:56px;height:33px;flex-shrink: 0; object-fit: " />
                                        <img src="<?= $sue['sue_partners_link']['url'] ?>" alt=" <?= $sue['sue_partners_link']['alt'] ?>"
                                            class="" style="width:4px; height:8px; object-fit:cover " />
                                    </div>
                                </div>
                            </a>
                        </div>
